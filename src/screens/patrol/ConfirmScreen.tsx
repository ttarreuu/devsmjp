...
const ConfirmScreen = () => {
    ...
    const handleSubmit = async () => {
        try {
          ...
          saveLogPatrolTempLog(dateTime, picture, selectedValue, notes, nearestCheckpoint?.checkpointID, 'GPS');
          saveLogPatrol(dateTime, picture, selectedValue, notes, nearestCheckpoint?.checkpointID, 'GPS');  
          navigation.goBack();
        } catch (err) {
          console.log(err);
        }
